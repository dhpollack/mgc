...
# bytenet networks
python -m infer --model-name bytenet --batch-size 10 --log-interval 20 --loss-criterion bce --max-len 57344 --load-model output/states/bytenet_bce_balanced_final.pt
